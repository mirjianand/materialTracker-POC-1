...
CREATE TABLE `transfer_items` (
  ...
  CONSTRAINT `transfer_items_ibfk_2` FOREIGN KEY (`inventory_id`) REFERENCES `inventory` (`id`) ON DELETE SET NULL,
  CONSTRAINT `transfer_items_ibfk_3` FOREIGN KEY (`item_master_id`) REFERENCES `item_master` (`id`) ON DELETE SET NULL
...
INSERT INTO `transfer_items` VALUES (1,1,101,16,1,'accepted','E2E'),(4,4,107,25,5,'accepted','Test transfer');
